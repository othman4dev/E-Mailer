        ...
        <main class="d-flex gap">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <form action="/updatemail/{{$data->id}}" method="post" class="needs-validation" novalidate>
                            @csrf

                            <div class="mb-3">
                                <label for="name" class="form-label">email:</label>
                                <input type="text" class="form-control" id="name" name="email" value ={{$data->email}} required placeholder="Please provide a name">
                            </div>
